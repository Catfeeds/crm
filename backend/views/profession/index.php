        ...
        <div class="row mb-md">
            <div class="col-sm-12 col-xs-12">
                <ul class="nav nav-tabs custom-tab mb-md">
                    <li class="active"><a href="/profession/index">职业</a></li>
            ...
            <div class="col-sm-3 col-xs-4">
                <input class="btn btn-primary btn-sm mr-10" onclick="profession.createLayer()" value="新增职业" type="button">
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered table-list-check">
                                    <thead>
                                        <tr>
                                            <th width="60">序号</th>
                                            <th width="150">职业名称</th>
                                            <th width="350">职业描述</th>
                                            <th>状态</th>
                                            <th class="t-c">操作</th>
                                        </tr>
                                    </thead>
                                        ...
                                        <tr>
                                            ...
                                            <td class="t-c va-m">
                                                <div class="operation">
                                                    ...
                                                    <a onclick="profession.updateLayer($(this));" href="javascript:;" intentionId="<?php echo $val['id'];?>">编辑</a>
                                                    <?php
                                                    if($val['is_special'] == 0){
                                                    ?>
                                                    <span>|</span>
                                                    <a href="/profession/update-status?id=<?php echo $val['id'];?>&status=<?php echo intval(!$val['status']) ?>"><?php echo $btnName; ?></a>
                                                    <?php
                                                    }
                                                    ?>
                                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">新增职业</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <input class="form-control" id="input_id" placeholder="职业的id，编辑数据用到" type="hidden">
                    <div class="row">
            ...
            <div class="modal-footer">
                <button onclick="profession.cancelLayer();" type="button" class="btn btn-default btn-sm" data-dismiss="modal">取消</button>
                <button onclick="profession.submitForm();" type="button" class="btn btn-primary btn-sm">确认</button>
            </div>
        </div>
    </div>
</div>
