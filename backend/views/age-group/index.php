    ...
    <section class="content-body">
        <div class="row mb-md">
            ...
            <div class="col-sm-3 col-xs-4">
                <input class="btn btn-primary btn-sm mr-10" onclick="ageGroup.createLayer()" value="新增年龄段" type="button">
            </div>
        </div>
        <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td class="t-c va-m">
                                                <div class="operation">
                                                    ...
                                                    <a onclick="ageGroup.updateLayer($(this));" href="javascript:;" intentionId="<?php echo $val['id'];?>">编辑</a>
                                                    <?php
                                                    if($val['is_special'] == 0){
                                                    ?>
                                                    <span>|</span>
                                                    <a href="/age-group/update-status?id=<?php echo $val['id'];?>&status=<?php echo intval(!$val['status']) ?>"><?php echo $btnName; ?></a>
                                                    <?php
                                                    }
                                                    ?>
                                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">新增年龄段</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <input class="form-control" id="input_id" placeholder="年龄段的id，编辑数据用到" type="hidden">
                    <div class="row">
            ...
            <div class="modal-footer">
                <button onclick="ageGroup.cancelLayer();" type="button" class="btn btn-default btn-sm" data-dismiss="modal">取消</button>
                <button onclick="ageGroup.submitForm();" type="button" class="btn btn-primary btn-sm">确认</button>
            </div>
        </div>
    </div>
</div>
