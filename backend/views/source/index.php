        ...
        <div class="row mb-md">
            <div class="col-sm-12 col-xs-12">
                <ul class="nav nav-tabs custom-tab mb-md">
                    ...
                    <li class="active"><a href="/source/index" title='广播、户外广告...'>信息来源</a></li>
                    <li><a href="/age-group/index">年龄段</a> </li>
                    <li><a href="/planned-purchase-time/index">拟购时间</a></li>
                </ul>
            </div>
            <div class="col-sm-3 col-xs-4">
                <input class="btn btn-primary btn-sm mr-10" onclick="source.createLayer()" value="新增信息来源" type="button">
            </div>
        </div>
        <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td class="t-c va-m">
                                                <div class="operation">
                                                    ...
                                                    <a onclick="source.updateLayer($(this));" href="javascript:;" intentionId="<?php echo $val['id'];?>">编辑</a>
                                                    <?php
                                                    if($val['is_special'] == 0){
                                                    ?>
                                                    <span>|</span>
                                                    <a href="/source/update-status?id=<?php echo $val['id'];?>&status=<?php echo intval(!$val['status']) ?>"><?php echo $btnName; ?></a>
                                                    <?php
                                                    }
                                                    ?>
                                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">新增信息来源</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <input class="form-control" id="input_id" placeholder="信息来源的id，编辑数据用到" type="hidden">
                    <div class="row">
            ...
            <div class="modal-footer">
                <button onclick="source.cancelLayer();" type="button" class="btn btn-default btn-sm" data-dismiss="modal">取消</button>
                <button onclick="source.submitForm();" type="button" class="btn btn-primary btn-sm">确认</button>
            </div>
        </div>
    </div>
</div>
