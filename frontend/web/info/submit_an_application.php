...
<body>
    <div class="content" style="padding-top: 0px;">
        ...
        <div class="weui-btn-area">
            <a class="weui-btn weui-btn_primary" href="javascript:" id="showTooltips">上传附件</a>
        </div>
    </div>
...
//                    console.log(arr)
    ...
    $("#showTooltips").click(function(){
        ...
        $.post(url,{'r':r,'order_id':order_id,'type':1,'arr':arr},function (data) {
            $.toast(data.message);
            if (data.code == 1) {
                setTimeout(function(){
