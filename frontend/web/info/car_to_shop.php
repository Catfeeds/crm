    ...
    <div class="content" style="padding-top: 0px;">
        ...
        <div id="files">
            ...
            <div class="page__bd">
                            ...
                            <div class="weui-uploader">
                                <div class="weui-uploader__bd">
                                    ...
                                    <div class="weui-uploader__input-box">
                                        <input id="u1" val="1" class="weui-uploader__input" name="file" type="file" accept="image/*" multiple="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="weui-cell__bd">
                            <div class="weui-uploader">
                                <div class="weui-uploader__bd">
                                    ...
                                    <div class="weui-uploader__input-box">
                                        <input id="u2" val="2" class="weui-uploader__input" name="file" type="file" accept="image/*" multiple="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="weui-cell__bd">
                            <div class="weui-uploader">
                                <div class="weui-uploader__bd">
                                    ...
                                    <div class="weui-uploader__input-box">
                                        <input id="u3" val="3" class="weui-uploader__input" name="file" type="file" accept="image/*" multiple="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <form id="f4" method="post" action="" enctype="multipart/form-data">
                    <input type="hidden" name="sign" value="xxx" >
                  <div class="weui-cells weui-cells_form froms " >
                        <p class="titles">车辆照片</p>
                        <div class="weui-cell__bd">
                            <div class="weui-uploader">
                                <div class="weui-uploader__bd">
                                    <ul class="weui-uploader__files">
                                    ...
                                    <div class="weui-uploader__input-box">
                                        <input id="u4" val="4" class="weui-uploader__input"  name="file" type="file" accept="image/*" multiple="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <form id="f5" method="post" action="" enctype="multipart/form-data">
                    <input type="hidden" name="sign" value="xxx" >
                      <div class="weui-cells weui-cells_form froms " >
                            <p class="titles">车辆里程数</p>
                            <div class="weui-cell__bd">
                                <div class="weui-uploader">
                                    <div class="weui-uploader__bd">
                                        <ul class="weui-uploader__files">
                                        ...
                                        <div class="weui-uploader__input-box">
                                            <input id="u5" val="5" class="weui-uploader__input" name="file" type="file" accept="image/*" multiple="">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="weui-btn-area" id="isCheck" style="display: none;">
            <a class="weui-btn weui-btn_primary" href="javascript:" id="showTooltips">确认到店</a>
        </div>
    </div>
...
//    var r = '<?php //echo $_POST['r'];?>//';
    ...
    $("#showTooltips").click(function(){
        ...
        $.post(url,{'r':r,'order_id':order_id,'type':2,'arr':arr},function (data) {
            $.toast(data.message);
            if (data.code == 1) {
                setTimeout(function(){
