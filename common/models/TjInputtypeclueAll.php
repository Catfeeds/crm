...
/**
 * This is the model class for table "crm_tj_inputtypeclue_all".
 *
 * @property string $id
 ...
 */
class TjInputtypeclueAll extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'crm_tj_inputtypeclue_all';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['create_date', 'input_type_id', 'num'], 'required'],
            [['create_date'], 'safe'],
